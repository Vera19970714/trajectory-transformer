...
if __name__ == '__main__':
    ...
    parser.add_argument('-testing_dataset_choice', default='shampoo', type=str)  # choices: yogurt, shampoo, combine
    parser.add_argument('-cross_dataset', default='None', type=str) # DONOT USE choices: None, Pure, Mixed, Cross,Combine
    ...
    parser.add_argument('-log_name', default='yogurt', type=str)
    parser.add_argument('-write_output', type=str, default='True')
    parser.add_argument('-output_path', type=str, default='./dataset/checkEvaluation/yogurt/')
