...
class Conv_AutoencoderModel(pl.LightningModule):
    def __init__(self, args):
        ...
        self.total_step = 0
        self.isRetrain = args.do_retrain
    ...
    def processData(self, src_pos, src_img, tgt_input, tgt_img):
        ...
        src_pos_2d[0, :, 0] = -1
        src_pos_2d[0, :, 1] = -1
        return src_pos_2d, tgt_input_2d, src_img, tgt_img, \
               src_mask, tgt_mask, src_padding_mask, tgt_padding_mask, src_padding_mask

    def processDataOnlyTgt(self, tgt_input, tgt_img):
        tgt_mask, tgt_padding_mask = create_mask_only_tgt(tgt_input)
